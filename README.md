# Portfólio Clara Cabral Lisboa
Projetos e códigos para aprender e aplicar Estatística, Ciência de Dados e Machine Learning no Python e no R.

Clara Cabral Lisboa
- Espeialista em Estatística para Ciência de Dados pela PUC Minas
- Cursando Ciência de Dados e Inteligência Artificial pelo Senai Cimatec (segunda graduação)
